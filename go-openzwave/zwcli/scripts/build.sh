...
if [ ! -d $GOPATH/src/github.com/shayne/zwave/go-openzwave ]; then
	git clone git@github.com:ninjasphere/go-openzwave.git $GOPATH/src/github.com/shayne/zwave/go-openzwave
fi
